...
Objectify este un emulator de streaming muzical (inspirat de Spotify), dezvoltat pentru a pune în practică și a demonstra conceptele fundamentale ale Programării Orientate pe Obiecte (POO). Proiectul simulează un ecosistem muzical interactiv, punând accent pe un cod curat, modularitate și modelarea logică a datelor.
